...
Depending on the orientation of your Pico Display, you may want the output facing a different direction. Calling `display.flip()` 'turns' the screen 180º. This is useful if your project mounts the screen with buttons Y/B on top instead of the default A/X buttons on top.

<details>
    <summary>Let's flip() out</summary>
